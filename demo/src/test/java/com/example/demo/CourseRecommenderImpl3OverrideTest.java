...
public class CourseRecommenderImpl3OverrideTest {

    @Mock
    private JPACourseRepository repository;

    @InjectMocks
    private CourseRecommenderImpl3Override recommender;

    @Test
    public void givenList_whenRecommendCourses_thenReturnCourses(){
        Course course1 = new Course(1, 5, "Test Desc", "Test 1");
        Course course2 = new Course(2, 6, "Test Desc", "Test 2");
        ...
        given(repository.findByCreditGreaterThan(4, pageable)).willReturn(page);
